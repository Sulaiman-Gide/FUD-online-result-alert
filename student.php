...
function getStudentLevel($student_id) {
    // Extract the year part from the registration number
    $parts = explode('/', $student_id);
    if (count($parts) >= 3) {
        $year = $parts[2]; // Get the year part
    } else {
        return "Unknown"; // Return Unknown if the format is invalid
    }

    // Map the year to the appropriate level
    switch ($year) {
        case '19':
            return 400;
        case '21':
        ...
        case '23':
            return 100;
        default:
            return "Unknown"; // Default to Unknown if the year doesn't match
    }
}
...
<head>
    ...
    <title>Federal University Dutse - Student Dashboard</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <a class="navbar-brand" href="index.html">
            ...
            <h1 class="text">Federal University Dutse</h1>
        </a>
