...
<body>
    <div class="form-group">
        <form action="login.php" method="post">
            ...
            <input type="text" class="" id="student_id" placeholder="FCP/CSC/19/0000" name="student_id" oninput="this.value = this.value.toUpperCase();" required>
            ...
            <div class="form-footer">
                ...
                <a href="#" class="go-back">Forget Password</a>
            </div>
